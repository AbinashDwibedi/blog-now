...
function Messages({ setOpenRightMenu, openRightMenu }) {
  ...
  return (
    <div className="messages-container">
      ...
      className={`h-screen flex transition-all flex-col bg-gradient-to-br from-blue-50 to-pink-50 p-4 rounded-xl shadow-lg w-1/4  md:relative fixed md:right-0 ${
    ...
    <div className="messages w-3/4 absolute right-0 top-0 p-4 border-2">
